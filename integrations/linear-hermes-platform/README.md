...
Expected source result for 0.6.0: `193/193 OK`. `/health` exposes the active inbound `data_event_types` allowlist so a rollout can verify that accepted event contract without inspecting source files.
