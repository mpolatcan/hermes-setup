...
These installed runtime directory and script names are retained as compatibility
identifiers. This source taxonomy migration does not rename, reinstall, or restart
the live service.
...
```bash
bash components/secrets/1password-hermes-bootstrap/scripts/install_onepassword_hermes_candidate.sh
```
...
/usr/bin/install -m 700 \
  components/secrets/1password-hermes-bootstrap/scripts/onepassword_hermes_send_launcher.sh \
...
```bash
/usr/bin/install -m 700 \
  components/secrets/1password-hermes-bootstrap/scripts/onepassword_hermes_serve_launcher.sh \
  /Users/mutlupolatcan/.hermes/scripts/hermes-serve-keychain.sh
/usr/bin/install -m 600 \
  components/secrets/1password-hermes-bootstrap/launchd/ai.hermes.serve-general.plist \
...
```bash
/usr/bin/install -m 700 \
  components/secrets/1password-hermes-bootstrap/scripts/onepassword_hermes_desktop_launcher.sh \
  /Users/mutlupolatcan/.hermes/scripts/hermes-desktop-keychain.sh
/usr/bin/install -m 600 \
  components/secrets/1password-hermes-bootstrap/launchd/ai.hermes.desktop-general.plist \
...
```bash
bash components/secrets/1password-hermes-bootstrap/scripts/install_onepassword_hermes_candidate.sh /absolute/target
```
