...
CANONICAL_SCRIPT = SCRIPT_DIR / "codex_usage_command.py"
LEGACY_RUNTIME_SCRIPT = SCRIPT_DIR / "codex_usage.py"
SCRIPT = CANONICAL_SCRIPT if CANONICAL_SCRIPT.exists() else LEGACY_RUNTIME_SCRIPT
