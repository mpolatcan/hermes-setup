...
The Python distribution, process label, and installed runtime continue to use the
existing `honcho-codex-adapter` compatibility identity. This source move does not
mutate or restart that runtime.
