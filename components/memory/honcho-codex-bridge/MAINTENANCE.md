...
| Purpose | Path |
|---|---|
| Tracked adapter | `/Users/mutlupolatcan/.hermes/source/hermes-setup/components/memory/honcho-codex-bridge` |
...
| Tracked launcher source | `scripts/honcho_codex_bridge_launcher.sh` |
