...
```bash
PYTHONPATH=components/operations/gateway-restart-coordinator \
  python3 -W error::ResourceWarning -m unittest \
  components/operations/gateway-restart-coordinator/tests/test_gateway_restart_coordinator.py -v
```

## Stage and activate

```bash
bash components/operations/gateway-restart-coordinator/scripts/install_gateway_restart_coordinator.sh
